...
namespace QuanLyCuaHangCoffee.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Profile()
        {
            ...
            var item = new RegisterAccountUserViewModel();
        ...
        public async Task<ActionResult> PostProfile(RegisterAccountUserViewModel req)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterAccountUserViewModel model)
        {
            if (ModelState.IsValid)
            {
